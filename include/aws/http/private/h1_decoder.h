...
AWS_HTTP_API void aws_h1_decoder_set_body_less(struct aws_h1_decoder *decoder, bool body_less);
...
AWS_HTTP_API bool aws_h1_decoder_get_body_less(const struct aws_h1_decoder *decoder);
