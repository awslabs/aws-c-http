...
AWS_HTTP_API void aws_h1_decoder_set_expects_body(struct aws_h1_decoder *decoder, bool expects_body);
...
AWS_HTTP_API bool aws_h1_decoder_get_expects_body(const struct aws_h1_decoder *decoder);
