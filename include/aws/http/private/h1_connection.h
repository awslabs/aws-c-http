 ...
 * handler into a dummy pass-through.  It is valid to switch protcols to to the same protocol; in this way using
 * an http proxy behaves the same whether we're transitioning to http or any other protocol.
 *
