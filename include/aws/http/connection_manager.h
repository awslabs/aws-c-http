...
struct aws_http_connection_manager_options {
     ...
     * `socket_options.network_interface_name` is set, an `` error will be raised. This option is only supported on
     * Linux and MacOS. On other platforms, `AWS_ERROR_PLATFORM_NOT_SUPPORTED` will be raised.
     */
