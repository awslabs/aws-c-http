...
H1_ENCODER_TEST_CASE(h1_encoder_content_length_header) {
    ...
    ASSERT_SUCCESS(aws_h1_encoder_message_init_from_request(&encoder_message, allocator, request, &chunk_list, false));
...
static int s_test_bad_request(
    ...
    ASSERT_ERROR(
        expected_error,
        aws_h1_encoder_message_init_from_request(&encoder_message, allocator, request, &chunk_list, false));
