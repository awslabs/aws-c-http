...
static struct aws_http_connection_manager_system_vtable s_default_system_vtable = {
    ...
    .is_connection_aviable = aws_http_connection_new_requests_allowed,
...
int aws_http_connection_manager_release_connection(
    ...
    bool should_release_connection = !manager->system_vtable->is_connection_aviable(connection);
