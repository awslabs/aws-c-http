...
const char *aws_http_method_to_str(enum aws_http_method method) {
    ...
    case AWS_HTTP_METHOD_DELETE:  return "DELETE";
    case AWS_HTTP_METHOD_GET:     return "GET";
    case AWS_HTTP_METHOD_HEAD:    return "HEAD";
    case AWS_HTTP_METHOD_OPTIONS: return "OPTIONS";
    case AWS_HTTP_METHOD_PATCH:   return "PATCH";
    case AWS_HTTP_METHOD_POST:    return "POST";
    case AWS_HTTP_METHOD_PUT:     return "PUT";
    case AWS_HTTP_METHOD_TRACE:   return "TRACE";
    default: return NULL;
    }
}
...
const char *aws_http_version_code_to_str(enum aws_http_version version) {
    switch (version) {
    case AWS_HTTP_VERSION_UNKNOWN: return "UNKNOWN";
    case AWS_HTTP_VERSION_1_0:     return "1.0";
    case AWS_HTTP_VERSION_1_1:     return "1.1";
    case AWS_HTTP_VERSION_2_0:     return "2.0";
    default: return NULL;
    }
}
